...
import {
  ...
  //   type UserListType,
  //   type VerificationTokenListType,
} from './schema';
...
export function CustomPgDrizzleAdapter(
  ...
  return {
    async createUser(userData: UserListType) {
    ...
    async linkAccount(account: AccountListType) {
    ...
    async createSession(data: SessionListType) {
    ...
    async updateSession(session: SessionListType) {
      await db
        .update(sessions)
        .set(session)
    ...
    async createVerificationToken(
      verificationToken: VerificationTokenListType
    ) {
