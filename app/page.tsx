...
export default function Page() {
  return (
    <main className="relative flex w-screen flex-col overflow-y-auto">
      <SplineViewer
        url="https://prod.spline.design/2GLk35LgytPBcf1w/scene.splinecode"
        className="-z-1 fixed h-screen w-screen"
      />
      <section className="z-10 flex h-screen w-screen flex-col">
        <div className="flex h-1/3 flex-row flex-wrap">
          ...
          <div className="z-10 flex h-full w-full items-center justify-center border border-neutral-300 bg-slate-400/50 backdrop-blur-xl md:w-1/3">
            ...
            <Image
              ...
              width={100}
              height={100}
              className="absolute w-1/4 md:w-1/3"
            />
          </div>
        </div>
        <div className="z-0 flex h-1/3 flex-row flex-wrap md:z-10">
      ...
      <section className="z-10 flex h-screen w-screen flex-col md:hidden">
        <div className="flex h-1/3 flex-row flex-wrap">
      ...
      <section className="z-10 hidden h-screen w-screen flex-col md:flex">
        <div className="flex h-1/3 flex-row flex-wrap">
          <div className="flex h-full w-full items-center justify-center border border-neutral-300 font-bold text-2xl md:w-2/3">
            <p className="ambit px-4 text-center font-thin text-3xl md:text-5xl">
              {/* Making things pop since 2015 */}
