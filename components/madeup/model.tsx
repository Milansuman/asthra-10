    ...
    return (
        <>
            ...
            <div className={className} dangerouslySetInnerHTML={{
                __html: `<model-viewer id="model-viewer" loading="eager" src="${GLBPATH}" ar ar-modes="webxr scene-viewer quick-look" camera-controls tone-mapping="neutral" poster="${altImage}" shadow-intensity="1" ></model-viewer>`
            }} />
        </>
    );
}