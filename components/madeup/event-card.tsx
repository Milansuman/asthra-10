...
const EventCard: React.FC<EventCardProps> = ({ data, credits, footerNote }) => {
	...
	return (
		<div
			...
			className="border  group/canvas-card flex items-center justify-center border-white/[0.2]  max-w-sm w-full mx-auto p-2 h-[30rem] relative"
		>
			...
			<div className="relative z-20 glass ambit">
				<div className="text-white p-4 text-xl flex items-center flex-col justify-center opacity-0 group-hover/canvas-card:opacity-100 absolute left-0 top-0 right-0 bottom-0 z-10    font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200">
