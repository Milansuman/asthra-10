...
export default function Footer() {
  return (
    <footer className="ambit w-full bg-[#0A0A19] font-[350] text-white">
      {/* Top Section */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y divide-dashed divide-white/50 lg:divide-y-0">
        {/* Header Row */}
        <div className="col-span-1 sm:col-span-2 border-white/50 border-b p-4 sm:p-6 lg:p-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl tracking-wide">
            Asthra 9.0
          </h2>
        </div>

        <div className="flex items-center justify-center border-white/50 border-b p-4 sm:border-x">
          <Image
        ...
        <div className="p-4 sm:p-6 lg:p-8 border-white/50 border-b">
          <div className="text-center sm:text-right">
            <span className="text-4xl sm:text-5xl md:text-6xl">12%</span>
          </div>
        </div>
